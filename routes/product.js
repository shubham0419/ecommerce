...
const {showAllProducts, productForm , createProduct , showProduct , editProductForm , updateProduct , deleteProduct, sellerProducts} =  require('../controllers/product')
...
router.get("/user/myproducts", isLoggedIn, isSeller, sellerProducts);
